...
document
  .getElementById("allAnimals")
  .addEventListener("click", () => printTables("animals"));
document
  .getElementById("allResCent")
  .addEventListener("click", () => printTables("rescue_centers"));
document
  .getElementById("allCustomer")
  .addEventListener("click", () => printTables("customers"));
document
  .getElementById("allPerson")
  .addEventListener("click", () => printTables("contact_persons"));
document
  .getElementById("allDonations")
  .addEventListener("click", () => printTables("donations"));
...
document
  ...
  .addEventListener("click", () => toggleRemoveView("animals"));
document
  .getElementById("removeResCenter")
  .addEventListener("click", () => toggleRemoveView("rescue_centers"));
document
  .getElementById("removeCustomer")
  .addEventListener("click", () => toggleRemoveView("customers"));
...
document
  .getElementById("modifyAnimal")
  .addEventListener("click", () => toggleModifyView("animals"));
document
  .getElementById("modifyResCenter")
  .addEventListener("click", () => toggleModifyView("rescue_centers"));
document
  .getElementById("modifyContact")
  .addEventListener("click", () => toggleModifyView("contact_persons"));
...
document
  .getElementById("insertAnimal")
  .addEventListener("click", () => toggleInsertView("animals"));
document
  .getElementById("insertResCenter")
  .addEventListener("click", () => toggleInsertView("rescue_centers"));
